...
class Exp:
	...
	def get_runtime_vars(self):
		while True:
			runTimeVarsOrder = ['subjCode','seed', 'angleAssign','labelAssign','condition','room','date_time']
			self.runTimeVars = getRunTimeVars(
												...
												runTimeVarsOrder,'wc2_3_v1')
			self.outputFile = openOutputFile('data/'+self.runTimeVars['subjCode'],'wc2_3_v1')
			if self.outputFile:
				break
